...
bot = (ChatBot(local=False, vlm=False)
       ...
       .with_rag("insight/data_set.xlsx")
       .with_memory()
       .with_system_prompt(
           ...
           "7. SEARCH using all context fields (Product Name, Variant, Partition, Price). When searching for 'KitKat Variant 16', find the row where Variant=16 and the product name contains KitKat.\n"
           "8. In your ANSWER, do NOT show raw variant numbers or SKU IDs — only show the product name, price, and partition.\n"
...
async def startup_event():
    ...
    try:
        ...
        if os.path.exists("insight/data_set.xlsx"):
            df = pd.read_excel("insight/data_set.xlsx")
